...
@section('content')
    <div class="body" ng-controller="resourceDetailController">
        ...
        <div class="posi">
            ...
            <a href="">
                <div class="li_nxt"> 教研备课 > 主题资源详情</div>
            </a>
        </div>
            ...
            <div class="de_con_l">
                ...
                <div class="de_con_l_con">
                    @if (in_array($type,['.mp4','.avi','.rmvb','.wmv','.3gp','.flv','.mpg','.mov']))
                        <video src="{{ URL::asset($resDetail->resourceUrl) }}" width="100%" height="100%"
            ...
            <div class="de_con_r" style="float:right">
                ...
                <div class="vde_con_r_con" ng-repeat="i in other">
                    ...
                    <div class="vde_con_r_con_b">
                        ...
                        <div class="vde_con_r_con_b_rq" style="float: right" ng-bind="i.create_at"></div>
                    </div>
                </div>
