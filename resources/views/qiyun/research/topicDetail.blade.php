...
@section('content')
    <div class="body" ng-controller="topicInfoCtrl">
        <div class="body_left">
            <div class="body_left_top">
                <div ng-class="{disable: contentblock}">
                    ...
                    <div class="body_left_top_con" ng-bind="content.content"></div>
                </div>
            ...
            <div class="body_left_bottom">
                @if ($datas['prev'])
                    <a href="{{url('/lessonDetail/topicDetail/'.$datas['prev']->id)}}">
                ...
                @if ($datas['next'])
                    <a href="{{url('/lessonDetail/topicDetail/'.$datas['next']->id)}}">
        ...
        <div class="de_con_r" style="float:right">
            ...
            <div class="vde_con_r_con" ng-repeat="i in other">
...
@section('js')
    <script type="text/javascript" src="{{ URL::asset('js/qiyun/angular/controller/topicDetailController.js') }}"></script>
@endsection