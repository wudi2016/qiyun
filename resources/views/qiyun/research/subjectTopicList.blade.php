...
@section('content')
    <div class="body" ng-controller="resourceDetailController">
        ...
        <div class="posi">
            ...
            <a href="">
                <div class="li_nxt"> 教研评课 > 主题研讨话题列表</div>
            </a>
        </div>
        ...
        <div class="de_con">
            <div class="de_con_l">
                <div class="first_line">
                    <ul ng-class="{disable: subjectTopicListblock}">
                        <li ng-repeat="e in subjectTopicList">
                            <a style="color:#000;" href="{{url('/research/topicInfo/{[e.id]}')}}">
                    ...
                    <div class="spinner" style="padding:0px 200px;width:250px;margin-top: 20px;"
                         ng-class="{disable: subjectTopicList}">
                        <div class="bounce1"></div>
                        <div class="bounce2"></div>
                        <div class="bounce3"></div>
                    </div>
                    <div id="errorMessage" style="padding:0px 200px;width:250px;margin-top: 40px;"
                         ng-class="{disable: subjectTopicListmsg}">数据加载失败，请尝试 <a
                                ng-click="reload('subjectTopicList');">刷新</a> 一下
                    </div>
                    <span style="padding-top: 90px;display: block;" ng-bind="subjectTopicListError"></span>
                </div>
            </div>
        </div>
...
@section('js')
    <script type="text/javascript"
            src="{{ URL::asset('/js/qiyun/angular/controller/subjectTopicListController.js') }}"></script>
@endsection