...
@section('content')
    <div class="body" ng-controller="articleInfoCtrl">
        <div class="body_left">
            ...
            <div class="body_left_bottom">
                @if ($datas['prev'])
                    <a href="{{url('/research/articleInfo/'.$datas['prev']->id)}}">
                ...
                @if ($datas['next'])
                    <a href="{{url('/research/articleInfo/'.$datas['next']->id)}}">
        ...
        {{--<div class="body_right">--}}
            {{--<div class="body_right_top">文章列表</div>--}}
            {{--<div>--}}
...
@section('js')
    <script type="text/javascript" src="{{ URL::asset('js/qiyun/angular/controller/articleInfoController.js') }}"></script>
@endsection