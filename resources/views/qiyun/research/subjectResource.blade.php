...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/qiyun/research/subjectResource.css') }}">
@endsection
...
@section('content')
    ...
    <form>
        ...
        <!-- 提交信息部分 -->
        <div class="form_div1" ng-controller="subjectResourceCtrl">
            ...
            <div class="form_div1_miaosu">
                ...
                <textarea class="form_div1_textarea" name="describe" style="resize: none" placeholder="选填,简要介绍音视频的主要内容,方便更多人的预览和下载" ng-model="describe"></textarea>
            </div>
            <div style="height:50px"></div>
            <!-- 发布,取消 -->
            <div class="form_div1_fabu">
                <button id="btnSub" ng-click="insert();">发布</button>
                <span id="btnRes" ng-click="resourceReset(id);">取消</span>
            </div>
        </div>
    </form>
    <!-- 主体部分结束 -->
...
@endsection
@section('js')
    <script type="text/javascript" src="{{ URL::asset('js/qiyun/angular/controller/subjectResourceController.js') }}"></script>
