...
@section('content')
    <div class="body" ng-controller="resourceDetailController">
        ...
        <div class="posi">
            ...
            <a href="">
                <div class="li_nxt"> 教研备课 > 主题研讨资源列表</div>
            </a>
        </div>
        ...
        <div class="de_con">
            <div class="de_con_l">
                <div class="first_line">
                    <ul ng-class="{disable: subjectResourceListblock}">
                        <li ng-repeat="e in subjectResourceList">
                            <img src="{[e.pic]}" style="float: left;margin-top:15px;">
                            <a style="color:#000;" href="{{url('/research/subjectResourceDetail/{[e.id]}')}}">
                    ...
                    <div class="spinner" style="padding:0px 200px;width:250px;margin-top: 20px;"
                         ng-class="{disable: subjectResourceList}">
                        <div class="bounce1"></div>
                        <div class="bounce2"></div>
                        <div class="bounce3"></div>
                    </div>
                    <div id="errorMessage" style="padding:0px 200px;width:250px;margin-top: 40px;"
                         ng-class="{disable: subjectResourceListmsg}">数据加载失败，请尝试 <a
                                ng-click="reloadcourse('subjectResourceList');">刷新</a> 一下
                    </div>
                    <span style="padding-top: 90px;display: block;" ng-bind="subjectResourceListError"></span>
                </div>
            </div>
        </div>
...
@section('js')
    <script type="text/javascript"
            src="{{ URL::asset('/js/qiyun/angular/controller/subjectResourceListController.js') }}"></script>
@endsection