...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/qiyun/research/subjectAudio.css') }}">
@endsection
...
@section('content')
    ...
    <div class="posi">
        ...
        <a href="">
            <div class="li_nxt"> 教研备课 > 主题研讨 > 发布音视频 </div>
        </a>
    </div>
    <!-- 主图div -->
    <div class="zhutu">
    ...
    <form>
        ...
        <!-- 提交信息部分 -->
        <div class="form_div1" ng-controller="subjectAudioCtrl">
            ...
            <div class="form_div1_miaosu">
                ...
                <textarea class="form_div1_textarea" style="resize: none" name="describe" ng-model="describe" placeholder="选填,简要介绍音视频的主要内容,方便更多人的预览和下载"></textarea>
            </div>
            ...
            <div class="form_div1_fabu">
                ...
                <span id="btnRes" ng-click="audioReset(id);">取消</span>
            </div>
        </div>
    </form>
    <!-- 主体部分结束 -->
...
@endsection
@section('js')
    <script type="text/javascript" src="{{ URL::asset('js/qiyun/angular/controller/subjectAudioController.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/qiyun/member/jquery.uploadify.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/qiyun/research/subjectAudio.js') }}"></script>
@endsection
