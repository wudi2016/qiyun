...
@section('content')
    <div class="body" ng-controller="resourceDetailController">
        ...
        <div class="posi">
            ...
            <a href="">
                <div class="li_nxt"> 教研备课 > 主题研讨文章列表</div>
            </a>
        </div>
        ...
        <div class="de_con">
            <div class="de_con_l">
                <div class="first_line">
                    <ul ng-class="{disable: subjectArticleListblock}">
                        <li ng-repeat="e in subjectArticleList">
                            <a style="color:#000;" href="{{url('/research/articleInfo/{[e.id]}')}}">
                                <span ng-bind="'标题：' + e.name"></span>
                            </a>
                            <span ng-bind="'作者：' + e.author" style="text-align: right"></span>
                    ...
                    <div class="spinner" style="padding:0px 200px;width:250px;margin-top: 20px;"
                         ng-class="{disable: subjectArticleList}">
                        <div class="bounce1"></div>
                        <div class="bounce2"></div>
                        <div class="bounce3"></div>
                    </div>
                    <div id="errorMessage" style="padding:0px 200px;width:250px;margin-top: 40px;"
                         ng-class="{disable: subjectArticleListmsg}">数据加载失败，请尝试 <a
                                ng-click="reload('subjectArticleList');">刷新</a> 一下
                    </div>
                    <span style="padding-top: 90px;display: block;" ng-bind="subjectArticleListError"></span>
                </div>
            </div>
        </div>
...
@section('js')
    <script type="text/javascript"
            src="{{ URL::asset('/js/qiyun/angular/controller/subjectArticleListController.js') }}"></script>
@endsection