    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/school/doEditSchoolYear')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            ...
                            @if(\Auth::user()->level() > 3)
                                <select name="parentId" id="school" class="col-xs-10 col-sm-5">
                                    ...
                                    @foreach($data->schoolNames as $schoolnames)
                                        <option value="{{$schoolnames->id}}" @if($data->parentId == $schoolnames->id) selected @endif>{{$schoolnames->schoolName}}</option>
                                    @endforeach
                                </select>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="reportName" id="form-field-2" placeholder="年度名称" class="col-xs-10 col-sm-5" value="{{$data->reportName}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="startTime" id="form-field-1" placeholder="年度开始日期" class="col-xs-10 col-sm-5" value="{{$data->startTime}}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="background:url('{{asset("image/qiyun/research/addEvaluation/2.png")}}') no-repeat;background-position:right;" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="endTime" id="form-field-1" placeholder="年度结束日期" class="col-xs-10 col-sm-5" value="{{$data->endTime}}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="background:url('{{asset("image/qiyun/research/addEvaluation/2.png")}}') no-repeat;background-position:right;" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="reportTitle" id="form-field-2" placeholder="年度信息报告标题" class="col-xs-10 col-sm-5" value="{{$data->reportTitle}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <textarea name="reportBody" id="form-field-2" placeholder="年度信息报告内容" class="col-xs-10 col-sm-5" cols="30" rows="10" style="resize: none">{{$data->reportBody}}</textarea>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="reportYear" id="form-field-2" placeholder="年度信息报告年" class="col-xs-10 col-sm-5" value="{{$data->reportYear}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
