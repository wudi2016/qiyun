    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/evaluation/doEditEvaluatMember')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="parentId" id="" id="form-field-1" class="col-xs-10 col-sm-5">
                                @foreach($data->evaluatNames as $evaluatName)
                                    <option value="{{$evaluatName->id}}"@if($data->parentId == $evaluatName->id) selected @endif>
                                        {{$evaluatName->evaluatName}}
                                    </option>
                                @endforeach
                            </select>
                        </div>
