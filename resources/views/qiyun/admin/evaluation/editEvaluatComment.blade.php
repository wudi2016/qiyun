    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/evaluation/doEditEvaluatComment')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="evaluatId" id="form-field-1" class="col-xs-10 col-sm-5">
                                @foreach($data->evaluatNames as $evaluatnames)
                                    <option value="{{$evaluatnames->id}}" @if($data->evaluatId == $evaluatnames->id) selected @endif>{{$evaluatnames->evaluatName}}</option>
                                @endforeach
                            </select>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 评论回复用户 </label>

                        <div class="col-sm-9">
                            <input type="text" readonly name="username" id="form-field-1" placeholder="评论回复用户" class="col-xs-10 col-sm-5" value="{{$data->username}}" />
                        </div>
                    </div>
