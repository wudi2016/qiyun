    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/school/doEditSchoolDepartmentleader')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
...
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{--<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" />--}}
                            <select name="parentId" id="department" class="col-xs-10 col-sm-5">
                                <option value="" selected>---部门名称---</option>
                                @foreach($data->departNames as $departnames)
                                    <option value="{{$departnames->id}}" @if($data->parentId == $departnames->id) selected @endif>{{$departnames->departName}}</option>
                                @endforeach
                            </select>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle">
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" readonly  id="form-field-2" placeholder="部门负责人" class="col-xs-10 col-sm-5" value="{{$data->realname}}" />
                            <input type="hidden" name="uid" id="form-field-2" placeholder="部门负责人" class="col-xs-10 col-sm-5" value="{{$data->uid}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
