    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/school/doEitSchoolGradeleader')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
...
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 年级组长 </label>

                        <div class="col-sm-9">
                            <input type="text" readonly  id="form-field-2" placeholder="班主任" class="col-xs-10 col-sm-5" value="{{$data->realname}}" />
                            <input type="hidden" name="uid" id="form-field-2" placeholder="班主任" class="col-xs-10 col-sm-5" value="{{$data->uid}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
