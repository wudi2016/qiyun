...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            ...
            <form class="form-search"  method="get" action="{{url('admin/microlesson/microlessonCollectList')}}">
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                      ...
                                                      {{--</button>--}}
                                                      {{--
                                                      <a href="{{url('admin/microlesson/editcollect/'.$collect->id)}}" class="btn btn-xs btn-info">
                                                          <i class="icon-edit bigger-120"></i>
                                                      </a>
                                                      --}}
                                                      <a href="{{url('admin/microlesson/delcollect/'.$collect->id)}}" style="width:29px" class="btn btn-xs btn-danger" onclick="return confirm('删除后将无法找回,确定要删除吗?');">
