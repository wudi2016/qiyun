...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            <form action="{{url('admin/lesson/lessonArticleList')}}" method="get" class="form-search">
                                  ...
                                  <form action="">
                                      @foreach($data as $article)
                                          <tr>
                                              ...
                                              <td>{{$article->lessonSubjectName}}</td>
                                              <td>{{$article->title}}</td>
                                              ...
                                              <td>
                                                  <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                      ...
                                                      <a href="{{url('admin/lesson/lessonArticleEdit/'.$article->id)}}" class="btn btn-xs btn-info">
                                                          <i class="icon-edit bigger-120"></i>
                                                      </a>
                                                      {{--@endpermission--}}

                                                      {{--@permission('lesson.del')--}}
                                                      <a href="{{url('admin/lesson/delLessonArticle/'.$article->id)}}" class="btn btn-xs btn-danger" onclick="return confirm('删除后将无法找回,确定要删除吗?');">
