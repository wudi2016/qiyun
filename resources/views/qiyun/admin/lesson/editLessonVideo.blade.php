    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/lesson/doLessonVideoEdit')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    {{--<div class="form-group">--}}
                        {{--<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 音视频 </label>--}}

                        {{--<div class="col-sm-9">--}}
                            {{--<input type="text" name="videourl" id="form-field-1" placeholder="音视频url" class="col-xs-10 col-sm-5" value="{{$data->url}}" id="form-input-readonly" readonly="" />--}}
