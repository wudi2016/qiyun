    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/lesson/doLessonArticleEdit')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="lessonId"  id="form-field-1" class="col-xs-10 col-sm-5">
                                @foreach($data->lessonSubjectName as $lesson)
                                    <option value="{{$lesson->id}}"@if($data->lessonId == $lesson->id) selected @endif>
                                        {{$lesson->lessonSubjectName}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" id="form-field-1" placeholder="备课文章标题" class="col-xs-10 col-sm-5" value="{{$data->title}}" />
                        </div>
                    </div>
...
{{--                            <input type="text" name="content" id="form-field-2" placeholder="文章内容" class="col-xs-10 col-sm-5" value="{{$data->content}}" />--}}
                            <textarea name="content" id="container" placeholder="备课文章内容" style="resize: none;">{{$data->content}}</textarea>
