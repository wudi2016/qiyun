...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            <form action="{{url('admin/lesson/lessonVideoList')}}" method="get" class="form-search">
                <select name="type" id="form-field-1">
                    ...
                    <option value="3" @if($data->type == 3) selected @endif>音视频名称</option>
                                  ...
                                  <form action="">
                                      @foreach($data as $video)
                                          <tr>
                                              ...
                                              <td>{{$video->lessonSubjectName}}</td>
                                              <td>{{$video->name}}</td>
                                              <td><a class="fancybox" href="{{asset($video->url)}}" data-width="640" data-height="360">查看</a></td>
                                              <td>{{$video->describes}}</td>
                                              <td>{{$video->realname}}</td>
                                              ...
                                              <td>
                                                  <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                      ...
                                                      <a href="{{url('admin/lesson/lessonVideoEdit/'.$video->id)}}" class="btn btn-xs btn-info">
                                                          <i class="icon-edit bigger-120"></i>
                                                      </a>
                                                      {{--@endpermission--}}

                                                      {{--@permission('lesson.del')--}}
                                                      <a href="{{url('admin/lesson/delLessonVideo/'.$video->id)}}" class="btn btn-xs btn-danger" onclick="return confirm('删除后将无法找回,确定要删除吗?');">
