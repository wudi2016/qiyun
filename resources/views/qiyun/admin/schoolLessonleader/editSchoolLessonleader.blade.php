    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/school/doEditSchoolLessonleader')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
...
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{--<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" />--}}
                            <select name="parentId" id="schoolsubject" class="col-xs-10 col-sm-5">
                                <option value="" selected>---学科名称---</option>
                                @foreach($data->schoolsubjects as $schoolsubject)
                                    <option class="subject" value="{{$schoolsubject->id}}" @if($data->parentId == $schoolsubject->id) selected @endif>{{$schoolsubject->subjectName}}</option>
                                @endforeach
                            </select>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle">
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 备课组长 </label>

                        <div class="col-sm-9">
                            <input type="text" readonly  id="form-field-2" placeholder="备课组长" class="col-xs-10 col-sm-5" value="{{$data->realname}}" />
                            <input type="hidden" name="uid" id="form-field-2" placeholder="备课组长" class="col-xs-10 col-sm-5" value="{{$data->uid}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
...
@section('js')
    ...
    <script language="javascript" type="text/javascript">
        $('#school').change(function(){
            $('#schoolsubject').find('.subject').remove();
