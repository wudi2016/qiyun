    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12" style="width:100%;float: left;">
                ...
                <form action="{{url('admin/school/doAddSchoolLessonleader')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <div style="width: 50%;float: left;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                @else
                                    <input type="text" readonly name="school" id="" class="col-xs-10 col-sm-5" value="{{$data->schoolName}}" />
                                ...
                                @else
                                    <select name="gradeid" id="schoolgrade" class="col-xs-10 col-sm-10">
                                        ...
                                        @foreach($data->schoolGrade as $schoolGrades)
                                            <option value="{{$schoolGrades->id}}">{{$schoolGrades->gradeName}}</option>
                                        @endforeach
                                    </select>
                                @endif
...
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                {{--<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" />--}}
                                <select name="parentId" id="schoolsubject" class="col-xs-10 col-sm-10">
...
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                    ...
                    <div style="width: 500px;height:300px;float: left;">
                        <div class="top1" style="width: 500px;height:30px;font-weight: bold;line-height: 30px;">
                            <div style="width: 70px;float: left;">备课组长</div>
