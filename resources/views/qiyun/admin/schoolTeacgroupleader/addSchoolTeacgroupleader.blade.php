    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12" style="width:100%;float: left;">
                ...
                <form action="{{url('admin/school/doAddSchoolTeacgroupleader')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if(\Auth::user()->level() > 3)
                                    <select name="parentId" id="teachgroup" class="col-xs-10 col-sm-10">
                                ...
                                @else
                                    <select name="parentId" id="teachgroup" class="col-xs-10 col-sm-10">
                                        <option value="" selected>---教研组名称---</option>
                                        @foreach($data->schoolteachgroup as $schoolteachgroups)
                                            <option value="{{$schoolteachgroups->id}}">{{$schoolteachgroups->teachgroupName}}</option>
                                        @endforeach
                                    </select>
                                @endif
...
{{--                                    {!!isset($errors) ? $errors->first('parentId', '<span style="color:red;">:message</span>') : ""!!}--}}
                    ...
                    <div style="width: 500px;height:300px;float: left;">
                        <div class="top1" style="width: 500px;height:30px;font-weight: bold;line-height: 30px;">
                            <div style="width: 70px;float: left;">教研组长</div>
