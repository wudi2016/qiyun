        ...
        <div class="page-header">
            <h1>
                ...
                <small>
                    ...
                    查看权限用户组
                    <a href="{{ url( 'admin/auth/addRolePermission/'. $permissionID ) }}" class="btn btn-xs btn-success">添加用户组</a>
                </small>
            </h1>
        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                  <form action="">
                                      @foreach( $checkRolePermission as $permissions )
                                        <tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="{{ url( 'admin/auth/revokeManager/'. $permissions -> id .'/revokeRolePermission/2' ) }}" class="btn btn-xs btn-danger" onclick="return confirm('确认撤销该管理员权限?');">撤销权限</a>
                                                </div>
                                            </td>
                            ...
                            {!! $checkRolePermission -> appends( app('request') -> all() ) -> render() !!}
                        </div>
                    </div>
                </div>
