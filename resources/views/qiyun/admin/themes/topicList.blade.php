...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            <form action="{{url('admin/theme/topicList')}}" method="get" class="form-search">
                <select name="type" id="form-field-1">
                    ...
                    <option value="3" @if($data->type == 3) selected @endif>话题标题</option>
                                  ...
                                  <form action="">
                                      @foreach($data as $topic)
                                          <tr>
                                              ...
                                              <td>{{$topic->name}}</td>
                                              <td>{{$topic->title}}</td>
                                              <td class="hidden-480">{{$topic->content}}</td>
                                              ...
                                              <td>
                                                  <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                      ...
                                                      <a href="{{url('admin/theme/editTopic/'.$topic->id)}}" class="btn btn-xs btn-info">
                                                          <i class="icon-edit bigger-120"></i>
                                                      </a>
                                                      {{--@endpermission--}}

                                                      {{--@permission('theme.del')--}}
                                                      <a href="{{url('admin/theme/delTopic/'.$topic->id)}}" class="btn btn-xs btn-danger" onclick="return confirm('删除后将无法找回,确定要删除吗?');">
