...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            <form action="{{url('admin/theme/imageList')}}" method="get" class="form-search">
                                  ...
                                  <form action="">
                                      @foreach($data as $image)
                                          <tr>
                                              ...
                                              <td>{{$image->themeId}}</td>
                                              <td>{{$image->name}}</td>
                                              <td><img src="{{asset($image->imgurl)}}" width="50px" height="50px"></td>
                                              <td>{{$image->realname}}</td>
                                              <td>{{$image->create_at}}</td>
                                              <td>{{$image->update_at}}</td>
                                              ...
                                              <td>
                                                  <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                      ...
                                                      <a href="{{url('admin/theme/imageEdit/'.$image->id)}}" class="btn btn-xs btn-info">
                                                          <i class="icon-edit bigger-120"></i>
                                                      </a>
                                                      {{--@endpermission--}}

                                                      {{--@permission('theme.del')--}}
                                                      <a href="{{url('admin/theme/delImage/'.$image->id)}}" class="btn btn-xs btn-danger" onclick="return confirm('删除后将无法找回,确定要删除吗?');">
