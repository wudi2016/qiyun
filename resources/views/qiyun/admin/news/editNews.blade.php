    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/news/doNewsEdit')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <textarea name="description" id="form-field-1" placeholder="新闻描述" class="col-xs-10 col-sm-5" cols="30" rows="10" style="resize: none;">{{$data->description}}</textarea>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="source" id="form-field-1" placeholder="新闻来源" class="col-xs-10 col-sm-5" value="{{$data->source}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="author" id="form-field-1" placeholder="作者" class="col-xs-10 col-sm-5" value="{{$data->author}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <img src="{{$data->pic}}" id="uploadPreview" class="col-xs-10 col-sm-5"/>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="file" name="pic" id="uploadImage"  onchange="loadImageFile();" style="width:170px;height:40px;position: absolute;top: 0px;opacity: 0;" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="typeId"  id="form-field-1" class="col-xs-10 col-sm-5">
                                @foreach($data->typeNames as $tename)
                                    <option value="{{$tename->id}}"@if($data->typeId == $tename->id) selected @endif>
                                        {{$tename->typeName}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name="content" id="container" cols="50" rows="10">{{$data->content}}</textarea>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="clickNum" id="form-field-1" placeholder="点击数" class="col-xs-10 col-sm-5" value="{{$data->clickNum}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="favNum" id="form-field-1" placeholder="粉丝数" class="col-xs-10 col-sm-5" value="{{$data->favNum}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
