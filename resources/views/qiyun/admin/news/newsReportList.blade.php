...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            <form action="{{url('admin/news/newsReportList')}}" method="get" class="form-search">
                <select name="type" id="form-field-1">
                    ...
                    {{--<option value="3" @if($data->type == 3) selected @endif>分类错误</option>--}}
                                  ...
                                  <form action="">
                                      @foreach($data as $newsReport)
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="#">{{$newsReport->id}}</a>
                                              </td>
                                              <td>{{$newsReport->title}}</td>
                                              ...
                                              <td>
                                                  <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                      ...
                                                      <a href="{{url('admin/news/editNewsReport/'.$newsReport->id)}}" class="btn btn-xs btn-info">
                                                          <i class="icon-edit bigger-120"></i>
                                                      </a>
                                                      {{--@endpermission--}}

                                                      {{--@permission('news.del')--}}
                                                      <a href="{{url('admin/news/delNewsReport/'.$newsReport->id)}}" class="btn btn-xs btn-danger" onclick="return confirm('删除后无法找回,确定还要删除吗?');">
