...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        @endif
    <div class="page-content" ng-controller="gradeAddController">
...
@section('js')
  <script type="text/javascript" src="{{ URL::asset('/js/qiyun/angular/controller/admin/gradeAddController.js') }}"></script>
@endsection
