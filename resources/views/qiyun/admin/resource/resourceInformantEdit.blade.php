    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/resource/doResourceInformantEdit')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 资源ID </label>

                        <div class="col-sm-9">
                            <input readonly="" type="text" name="rid" class="col-xs-10 col-sm-5" id="form-input-readonly" value="{{$data->rid}}" />
                            <input readonly="" type="hidden" name="id" class="col-xs-10 col-sm-5" id="form-input-readonly" value="{{$data->id}}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" readonly name="" id="form-field-1" placeholder="资源标题" class="col-xs-10 col-sm-5" value="{{$data->resourceTitle}}" />
                            <input type="hidden"  name="resourceId" id="form-field-1" class="col-xs-10 col-sm-5" value="{{$data->resourceId}}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
