...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search">
            <form action="{{url('admin/resource/resourceList')}}" method="get" class="form-search">
                <select name="type" id="form-field-1">
                    ...
                    <option value="6" @if($data->type == 6) selected @endif>所属学科</option>
                                  ...
                                  <form action="{{url('admin/resource/resourceMultiDel')}}" method="post">
                                      ...
                                      @foreach($data as $resources)
                                          <tr>
                                              ...
                                              <td>{{$resources->subjectName}}</td>
                                              <td>{{$resources->editionName}}</td>
                                              <td>{{$resources->gradeName}}</td>
