...
@section('content')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        @endif
    <div class="page-content" ng-controller="gradeEditController">
            ...
            <div class="col-xs-12">
                ...
                <form  class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  id="form-field-1" placeholder="gradeName" class="col-xs-10 col-sm-5" ng-model="postdata.gradeName"/>
                        </div>
                    </div>
...
@section('js')
  <script type="text/javascript" src="{{ URL::asset('/js/qiyun/angular/controller/admin/gradeEditController.js') }}"></script>
@endsection
