    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/teachergroup/addteachgradeexe')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="grade" id="grade" class="col-xs-10 col-sm-5" style="width:200px">
                                ...
                                @foreach($data as $grades)
                                    <option value="{{$grades->id}}">{{$grades->gradeName}}</option>
                                @endforeach
                            </select>
                            @endif
