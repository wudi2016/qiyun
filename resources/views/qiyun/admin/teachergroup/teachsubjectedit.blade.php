    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="{{url('admin/teachergroup/editteachsubjectsub')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                ...
                <input disabled="true" type="hidden" id="datausername" name="username" id="form-field-1" placeholder="id" class="col-xs-10 col-sm-5" value="{{$data->username}}" />
                    ...
                    <div class="space-4"></div>     
                     ...
                     <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">   对应学科  </label>
                        <div class="col-sm-9">
                            @if(\Auth::user() -> level() >=2 )
                            <select name="subject" id="subject" class="col-xs-10 col-sm-5" style="width:200px">
                                <option value=""  selected>--对应学科--</option>
                                @foreach($data->subjectName as $subjectNames)
                                <option value="{{$subjectNames->id}}"  @if($data->subjectid == $subjectNames->id) selected
                                @endif>{{$subjectNames->subjectName}}</option>
                                @endforeach
                            </select>
                            @endif
                            ...
                            @if(\Auth::user() -> level() <=1 )
                                @foreach($data->subjectName as $subjectNames)
                                    @if($data->subjectid == $subjectNames->id)
                                    <input type="text" name="" readonly id="form-field-1" class="col-xs-10 col-sm-5" value="{{$subjectNames->subjectName}}" />
                                    @endif
                                @endforeach
                            @endif
