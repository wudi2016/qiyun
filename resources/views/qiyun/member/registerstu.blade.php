	...
	<div id="register_content">
		...
		<div class="register_content_title">
			...
			<div class="register_content_title_block register_content_title_block_active">
				<div class="register_content_title_block_person register_content_title_block_person_active" style="background-position:50% 57%;"></div>学生
			</div>
        ...
        <!-- 学生 -->
		<form name="studentForm" action="/member/addMember" method="post" onsubmit="return postcheckb('yzmtsb')" class="register_content_form"  novalidate>
			...
			<div class="register_content_form_block">
				<div class="register_content_form_block_left">*学号</div>
				<div class="register_content_form_block_right">
					<input type="text" class="form_stunum" name="sno" placeholder="" value="{{ old('sno') }}">&nbsp;&nbsp;
					<span></span>
				</div>
			</div>
			<div style="height:15px;">
					<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;" >
						<span class="form_stunum_msg" style="line-height:15px;font-size:12px;" ></span>
				    </span>					
			</div>

			<div class="register_content_form_block">
				<div class="register_content_form_block_left">*类型</div>
				<div class="register_content_form_block_right">
					<select name="stuType" id="" class="form_stunum">
						<option value="0" @if(old('stuType') == 0) selected @endif>普通生</option>
						<option value="1" @if(old('stuType') == 1) selected @endif>统招生</option>
						<option value="2" @if(old('stuType') == 2) selected @endif>特长生</option>
						<option value="3" @if(old('stuType') == 3) selected @endif>复读生</option>
						<option value="4" @if(old('stuType') == 4) selected @endif>借读生</option>
					</select>
				</div>
			</div>
			<div style="height:15px;">
			...
			<div class="register_content_form_block">
				...
				<div class="register_content_form_block_right">
					<input type="password" class="form_password" name="password" id="psd2" placeholder="请输入您密码" ng-model="student.password">&nbsp;&nbsp;
					<span></span>
				</div>
			</div>
			<div style="height:15px;">
			...
			<div class="register_content_form_block">
				...
				<div class="register_content_form_block_right">
					<input type="password" name="repsd" placeholder="请输确认密码" ng-model="student.repsd"  pw-check="psd2">&nbsp;&nbsp;
					<span></span>
				</div>
			</div>
			<div style="height:15px;">
					<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;" ng-show="studentForm.repsd.$dirty && studentForm.repsd.$error.pwmatch && studentForm.repsd.$invalid">
						<span style="line-height:15px;font-size:12px;" ng-show="studentForm.repsd.$error.pwmatch" ng-bind="'*密码不一致。'"></span>
				    </span>
			</div>
			<div class="register_content_form_block">
			...
			<div class="register_content_form_block">
				...
				<div class="register_content_form_block_right">
					{{--<input type="text" name="phone"  class="form_phone" ng-model="student.phone" ng-pattern="/^1(3|5|8|7){1}[0-9]{9}$/">&nbsp;&nbsp;<button class="bind" type="button" onclick="sendMessage()">绑定</button>--}}
			...
			{{--<div style="height:15px;">--}}
					{{--<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;" ng-show="studentForm.phone.$dirty  && studentForm.phone.$invalid">--}}
						{{--<span style="line-height:15px;font-size:12px;" ng-show="studentForm.phone.$invalid" ng-bind="'*手机格式错误。'"></span>--}}
				    {{--</span>	--}}
			{{--</div>--}}
			<div style="height:15px;">
					<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;">
			...
			<div class="register_content_form_block">
				...
				<div class="register_content_form_block_right">
					{{--<input type="text" name="IDcard"  ng-model="student.IDcard" ng-pattern="/^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[a-zA-Z])$/">&nbsp;&nbsp;--}}
					<input type="text" name="IDcard" class="form_IDcard" value="{{ old('IDcard') }}" >&nbsp;&nbsp;
					<span></span>
				</div>
			</div>
			{{--<div style="height:15px;">--}}
					{{--<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;" ng-show="studentForm.IDcard.$dirty  && studentForm.IDcard.$invalid">--}}
						{{--<span style="line-height:15px;font-size:12px;" ng-show="studentForm.IDcard.$invalid" ng-bind="'*身份证号码格式错误。'"></span>--}}
				    {{--</span>	--}}
			{{--</div>--}}
			<div style="height:15px;">
					<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;">
			...
			<!-- <div class="register_content_form_block">
				<div class="register_content_form_block_left">学生类型</div>
				<div class="register_content_form_block_right">
				    <select name="stutype" id="stutype" ng-model="student.type">
			...
			<div class="register_content_form_block">
				...
				<div class="register_content_form_block_right">
					{{--<input type="email" name="email"  ng-model="student.email" placeholder="请输入邮箱地址">&nbsp;&nbsp;--}}
					<input type="email" name="email" class="form_email"  placeholder="请输入邮箱地址" value="{{ old('email') }}">&nbsp;&nbsp;
					<span></span>
				</div>
			</div>
			{{--<div style="height:15px;">--}}
					{{--<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;" ng-show="studentForm.email.$dirty  && studentForm.email.$invalid">--}}
						{{--<span style="line-height:15px;font-size:12px;" ng-show="studentForm.email.$invalid" ng-bind="'*非法的邮箱地址'"></span>--}}
				    {{--</span>					--}}
			{{--</div>			--}}
			<div style="height:15px;">
					<span style="color:red;width:300px;height:15px;display:block;margin-left:330px;text-align:left;">
			...
			<!-- <div class="register_content_form_block">
				<div class="register_content_form_block_left">学校</div>
				<div class="register_content_form_block_right">
					<input type="text" name="school"  ng-model="student.school">&nbsp;&nbsp;
					<span></span>
				</div>
			</div> -->
			<!-- <div style="height:15px;"></div>
			<div class="register_content_form_block">
				<div class="register_content_form_block_left">班级</div>
				<div class="register_content_form_block_right">
					<input type="text" name="class"  ng-model="student.class">&nbsp;&nbsp;
					<span></span>
				</div>
			</div> -->
			<!-- <div style="height:15px;"></div> -->
			<!-- <div class="register_content_form_block">
				<div class="register_content_form_block_left">家庭住址</div>
				<div class="register_content_form_block_right">
				    <textarea name="place" id="" cols="40" rows="2" ng-model="student.place"></textarea>
					<span></span>
				</div>
			</div>	
			<div style="height:15px;"></div> -->
			<div class="register_content_form_block">
				...
				<div class="register_content_form_block_right">
					...
					<input type="text" name="" class="yzmtsbsum" value="">&nbsp;&nbsp;<button type="button" class="yzm"></button>
					<span></span>
				</div>
			</div>																									
			<div style="height:15px;">
					<span class="yzmtsb yzmts disable" style="color:red;width:300px;height:15px;margin-left:330px;text-align:left;" >
			...
			<div class="register_content_form_block">
				...
				<div class="register_content_form_block_right">
					<input type="checkbox" name="serviceArticle"  ng-model="student.serviceArticle">
			...
			<div class="register_content_form_block">
				<div class="register_content_form_block_right">
					...
					<button  class="register_content_form_block_right_button "  ng-class="{disable : !student.serviceArticle}" ng-disabled="!studentForm.$valid">立即注册</button>
