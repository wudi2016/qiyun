//---Special effects
  ...
  $('.li_sel_xk_d_cn2').click(function(){
    $(this).parents('.li_sel_con2').find('.li_sel_xk_d_cn2').removeClass("sel");
    $('.li_sel_xk_d_cn').removeClass("sel");
    $('.li_sel_xk_d_cn3').removeClass("sel");
    $(this).addClass("sel");
  });

  $('.li_sel_xk_d_cn3').click(function(){
    $(this).parents('.li_sel_con3').find('.li_sel_xk_d_cn3').removeClass("sel");
    $('.li_sel_xk_d_cn').removeClass("sel");
    $('.li_sel_xk_d_cn2').removeClass("sel");
    $(this).addClass("sel");
  });
  ...
  $('.li_sel_xk_d_m').click(function () {
        // $(this).parent('.li_con_l_list').siblings().children('.li_con_l_list_cont').slideUp();
