primeApp.controller("gradeAddController", ["$scope","myHttp", function ($scope,myHttp) {
    ...
    $scope.post = function(){
    	...
    	if(!$scope.postdata.resourceSection){
		    ...
		    myHttp.postData('/admin/resource/gradeDoAdd',$scope.postdata).success(function (response) {
